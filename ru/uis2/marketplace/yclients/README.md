...
1. **Основное** - внесите настройки обработки звонков.  
...
- **Создавать клиента при первичном входящем звонке** - настройка позволяет создавать клиента по первичным звонкам. <br />
- **Фильтровать звонки** - укажите фильтры по которым должна срабатывать интеграция. <br />
- **Основной филиал** - укажите филиал, в который будут попадать звонки с номеров не выбранных в настройке ниже. <br />
- **Филиалы** - укажите соотношение вируальных номеров с филиалами выбраной сети. <br />
2. **Шаблоны** - укажите названия создаваемых контактов. <br />  
...
1. **Основное** - укажите основные настройки интеграции.<br />  
2. **Заявки** <br />

- **Создавать клиента при первичном обращении** - выберите настройку, если требуется передавать данные по первичным заявкам в Yclients. <br />  
- **Фильтры** - задайте условия, если требуется фильтровать заявки по сайтам и/или типам.<br />    

3. **Чаты**  <br />

- **Создавать клиента при первичном обращении** - выберите настройку, если требуется передавать данные по первичным чатам в Yclients.
При её выборе выводятся дополнительные настройки вариантов передачи чатов.  <br />

- **Условия создания клиента** - укажите на какой момент чата необходимо создавать клиента.<br />
- **Фильтры** - задайте условия, если требуется фильтровать чаты по сайтам и/или типам.<br />


4. **Филиал по умолчанию** - выберите основной филиал, в который будут попадать все чаты и заявки, не попавшие под условия ниже. <br /> 

5. **Филиалы для заявок** - укажите соотношение сайтов (для заявок) с филиалами выбранной сети.<br />
6. **Филиалы для чатов** - укажите соотношение каналов чата (для чатов) с филиалами выбранной сети.<br />
7. **Шаблоны** - укажите названия создаваемых контактов. <br />
