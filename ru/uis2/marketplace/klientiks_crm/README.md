...
- Перейдите в раздел **Виджеты** и выберите **Добавить виджеты IP-телефонии IToolLabs** <br />
![image](***.jpg)
<br />
...
- Для настройки всех трех виджетов в поле «Данные виджета (в JSON)» вставьте скопированный код из кабинета UIS. <br />
- Кликните **Сохранить**. <br />
