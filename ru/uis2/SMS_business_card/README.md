...
5. Укажите, нужно ли добавить имя, почту и внутренний номер сотрудника в текст SMS. Данные берутся из карточки <a href="/common/staff/employee-staff">сотрудника</a>.
