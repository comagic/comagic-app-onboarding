...
Для синхронизации сотрудников из amoCRM в UIS прожмите свитч активации интеграции **Синхронизация сотрудников** и нажмите **Сохранить** . После этого можете приступать к заполнению настроек интеграции.  <br /> 
...
Для передачи звонков из UIS в amoCRM прожмите свитч активации интеграции **Телефония** и нажмите **Сохранить**. После этого можете приступать к заполнению настроек интеграции.  <br /> 
...
Для передачи чатов из UIS в amoCRM прожмите свитч активации интеграции **Чаты** и нажмите **Сохранить**. После этого можете приступать к заполнению настроек интеграции.  <br /> 
...
Для передачи заявок из UIS в amoCRM прожмите свитч активации интеграции **Офлайн-заявки** и нажмите **Сохранить**. После этого можете приступать к заполнению настроек интеграции.  <br /> 
...
Для передачи сделок и смежных сущностей из amoCRM в UIS прожмите свитч активации интеграции "Сквозная аналитика" и нажмите **Сохранить**. После этого можете приступать к заполнению настроек интеграции.  <br /> 
...
6. Нажмите кнопку **Синхронизировать**, если требуется вручную выгрузить сделки за последние 20 минут. При первом подключении выгружаем сделки за прошедшие сутки. <br /> 
