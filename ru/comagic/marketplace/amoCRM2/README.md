...
<Alert type=warning>  Если вы хотите использовать 2 и более исключающих фильтра вместе (т.е. например не передавать звонок только с конкретного сайта и виртуального номера), то необходимо использовать оператор ИЛИ. </Alert>
