...
<Alert backgroundColor="#ccc" borderRadius="12" padding>Визитки отправляются только в период с 9:00 до 20:00 по московскому времени (GMT+3). Отправка происходит после пропущенного звонка на номер звонящему.</Alert>
...
<Alert backgroundColor="#ccc" borderRadius="12" padding>При отправке SMS на экране клиента отобразится стандартно имя отправителя — UIS. Изменить его невозможно из-за юридических требований. Название компании можно указать в тексте сообщения.</Alert>
